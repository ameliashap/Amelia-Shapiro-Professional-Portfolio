...
function inboxPage(body) { return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,nofollow"><title>Contact inbox | Amelia Shapiro</title><style>body{font:16px/1.6 Arial,sans-serif;color:#2e1647;background:#f6f1fb;margin:0}main{max-width:820px;margin:auto;padding:40px 24px}h1{font:40px Georgia,serif}a{color:#7536bc}article{background:white;border:1px solid #e3dce9;border-radius:8px;padding:24px;margin:20px 0}h2{font-size:20px;margin:0}time{font-size:14px;color:#665b73}.message{white-space:pre-wrap;overflow-wrap:anywhere}a:focus-visible{outline:3px solid #7536bc;outline-offset:4px}</style></head><body><main><a href="/#contact">Back to portfolio</a><h1>Contact inbox</h1>${body}</main></body></html>`; }
